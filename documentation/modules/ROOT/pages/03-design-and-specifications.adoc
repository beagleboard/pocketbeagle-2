...
image::hardware-design/block-diagram.webp[PocketBeagle 2 Block Diagram,width=900]
...
.I2C tree
image::hardware-design/i2c-tree.webp[I2C tree,width=900]
...
.Power tree
image::hardware-design/power-tree.webp[Power tree,width=900]
...
image::hardware-design/soc-functional-block-diagram.webp[SoC functional block diagram]
...
image::hardware-design/soc-dcaps.webp[SoC decoupling capacitors]
...
.SoC DDR controller
image::hardware-design/soc-ddr-controller.webp[SoC DDR controller]
...
image::hardware-design/soc-power-caps.webp[SoC power capacitors]
...
.SoC power
image::hardware-design/soc-power.webp[SoC power]
...
image::hardware-design/soc-vss.webp[SoC VSS (Ground) connection]
...
.Boot configuration
image::hardware-design/boot-config.webp[Boot configuration]
...
image::hardware-design/bootstrap.webp[Bootstrap pins connection]
...
.GPIO GPMC
image::hardware-design/gpio-gpmc.webp[GPIO GPMC]

GPIO MCASP0

.GPIO MCASP0
image::hardware-design/gpio-mcasp0.webp[GPIO MCASP0]

GPIO OSC0

.GPIO OSC0
image::hardware-design/gpio-osc0.webp[GPIO OSC0]

GPIO OSPI

.GPIO OSPI
image::hardware-design/gpio-ospi.webp[GPIO OSPI]

GPIO RGMII1

.GPIO RGMII1
image::hardware-design/gpio-rgmii1.webp[GPIO RGMII1]

GPIO RGMII2

.GPIO RGMII2
image::hardware-design/gpio-rgmii2.webp[GPIO RGMII2]

GPIO VOUT0

.GPIO VOUT0
image::hardware-design/gpio-vout0.webp[GPIO VOUT0]

MCU domain

.MCU domain
image::hardware-design/mcu-domain.webp[MCU domain]

MCU system

.MCU system
image::hardware-design/mcu-system.webp[MCU system]

Wakeup domain

.Wakeup domain
image::hardware-design/wkup-domain.webp[Wakeup domain]
...
.PMIC
image::hardware-design/pmic.webp[PMIC]
...
.3V3 power
image::hardware-design/dc-3v3.webp[3V3 power]
...
.Power path
image::hardware-design/power-path.webp[Power path]
...
.Battery charging
image::hardware-design/battery-charging.webp[Battery charging]

=== Decoupling capacitors

.VDD 1.2V capacitors
image::hardware-design/vdd-1v2-caps.webp[VDD 1.2V capacitors]

.VDD 1.8V capacitors
image::hardware-design/vdd-1v8-caps.webp[VDD 1.8V capacitors]

.VDD 3.3V capacitors
image::hardware-design/vdd-3v3-caps.webp[VDD 3.3V capacitors]

.VDDA 0.85V capacitors
image::hardware-design/vdda-0v85-caps.webp[VDDA 0.85V capacitors]

.VDD core capacitors
image::hardware-design/vdd-core-caps.webp[VDD core capacitors]
...
.USB connections
image::hardware-design/usb.webp[USB connections]
...
.P1 cape headers
image::hardware-design/cape-header-p1.webp[P1 cape headers]

==== P2 cape header

.P2 cape headers
image::hardware-design/cape-header-p2.webp[P2 cape headers]

=== MicroSD card slot

.MicroSD card slot
image::hardware-design/microsd.webp[MicroSD card slot]

.MicroSD card power
image::hardware-design/microsd-3v3.webp[MicroSD card power]
...
.Buttons
image::hardware-design/buttons.webp[Buttons]
...
.LED indicators
image::hardware-design/leds.webp[LED indicators]
...
image::hardware-design/emmc.webp[eMMC flash storage (not populated)]

=== 512MB LPDDR4

.512MB LPDDR4 RAM
image::hardware-design/ddr.webp[512MB LPDDR4 RAM]

.DDR power
image::hardware-design/ddr-power.webp[DDR power]
...
image::hardware-design/mspm0.webp[MSPM0L1105 as 8ch 12bit ADC & 4KB EEPROM]
...
.Serial debug port
image::hardware-design/uart-debug.webp[Serial debug port]

=== TagConnect (JTAG)

.JTAG
image::hardware-design/jtag.webp[JTAG]

.TagConnect (JTAG)
image::hardware-design/tag-connect.webp[TagConnect (JTAG)]
...
image::pocketbeagle-2-revA-dimensions.webp[PocketBeagle 2 RevA Dimensions]
